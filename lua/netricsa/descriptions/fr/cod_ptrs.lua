...
Le fusil utilise un système fonctionnant au gaz et tire une puissante cartouche perforante de 14,5 x 114 mm. Après le tir, le système recharge automatiquement l'arme, éliminant ainsi la nécessité pour le tireur d'actionner manuellement le verrou après chaque tir. Le PTRS dispose d'un chargeur à cinq cartouches avec un mécanisme de chargement à un coup.
...
- Son poids de près de 21 kg fait du transport du PTRS une tâche de combat à part entière.
- Il s'agit d'un cas où le fusil peut être utilisé comme arme antichar, et l'ennemi acquiert un grand respect pour le calibre 14,5 mm après le premier tir.
