...
- Le mode automatique permet une suppression efficace de l'ennemi, tandis que le mode à tir unique permet d'économiser les munitions et d'améliorer la précision contre des cibles éloignées.
- Le StG 44 est effectivement devenu l'un des principaux représentants d'une nouvelle classe d'armes aujourd'hui connue sous le nom de fusils d'assaut.
- Une mitraillette ? Un fusil ? Les Allemands décidèrent : « Pourquoi pas les deux ? ».