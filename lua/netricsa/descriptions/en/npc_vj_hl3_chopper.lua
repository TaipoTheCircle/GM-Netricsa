...
CLASS:      Combine Artic Hunter-Chopper
METABOLISM: Mechanical / Advanced helicopter, powered by Alliance power systems
PERCEPTION: Heavy attack helicopter
SIZE:       43 ft
ENDURANCE:  Very high
HOSTILITY:  Extreme
WEAPONS:    Pulse cannon, drop bombs / mines, guided missiles
REWARD:     5000 FC
THREAT:     Very high

DESCRIPTION:

The Combine Arctic Hunter-Chopper is a formidable Combine rotorcraft used to deliver heavy fire support, patrol zones, and hunt high-value targets like refugees or Resistance units. Manned by two Overwatch soldiers (pilot & gunner), it combines human design and Combine tech to create an aerial predator.
