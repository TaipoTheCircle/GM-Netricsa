...
WEAPON: MP 40 Submachine Gun With Silencer
...
While the MP 40 was less powerful than the rifle at long range, it was superior in urban combat, ambushes, and confined spaces where mobility and suppressive fire were paramount. Known for its iconic profile and distinctive sound, it remains one of the most recognizable firearms in history.

NOTES:

- Highly effective in close combat.
- Limited magazine capacity (32 rounds) - reload frequently.
- Accuracy drops off quickly at long range.
- Can be equipped with a suppressor and a larger magazine.
