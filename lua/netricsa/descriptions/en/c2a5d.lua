...
Here's the kicker: if one of Mental's portals manifests inside this chamber - say, at the warhead's beam housing - the destabilization would trigger a sympathetic detonation. Translation: one careless spawn, and we’ll all be remembered as a short-lived fireworks show.
