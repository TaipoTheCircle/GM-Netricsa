...
PERCEPTION:   Pack Predator
SIZE:         6,5 ft
ENDURANCE:    Low
HOSTILITY:    Very High
WEAPONS:      Sickle-like claws
REWARD:       200 FC
THREAT:       Moderate
...
The primary strength of these creatures lies not in individual traits, but in numbers. A single Drone rarely poses a serious problem. Fifty Drones usually hold the opposite opinion.

TIPS:

- Do not let the Swarm surround you.
- Flamethrowers and automatic weapons are excellent for thinning the Drone population.
- If you see one Drone, look around. The others are usually already close behind.
