...
Despite the change of allegiance, the turret remains an Combine machine by nature. It doesn't discriminate between tactics, doesn't conserve ammo, and knows no fear. The only thing that has changed is the target list.
