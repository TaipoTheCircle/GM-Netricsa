...
ENDURANCE:  Medium
HOSTILITY:  High
WEAPONS:    Missile Launcher (left "manipulator"), Energy Wave Scream, Close Combat "Claw"
REWARD:     1800 FC
THREAT:     High
...
At close range, Iron Maiden uses a short-duration super-tonal energy scream that not only deals damage but also disorients the target. In extreme cases, she can attack with her "claw"-a mechanical melee claw.

TIPS:

- Due to the rocket's blast radius, avoid open spaces and stay behind cover.
- Iron Maiden can teleport and dodge.
- Her super-tonal melee scream disorients the target-keep your distance.