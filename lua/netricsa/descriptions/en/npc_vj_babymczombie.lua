BABY ZOMBIE FROM THE MINECRAFT OVERWORLD
...
WEAPONS:    Hands, sometimes with a sword
REWARD:     300 FC
THREAT:     High

DESCRIPTION:

This is proof that it's not about size, but how you use it. Small, fast, and utterly ruthless, it manages to be more dangerous than its adult counterpart, despite being half its size.
...
- Don't try to run away - it's faster than you.
- Aim low. A sword strike to the legs works better than a headshot.
- Use a shield - it blocks attacks and gives you an opportunity to counter.
- Climb a block. The hatchling can't jump higher than 1.5 blocks.
- Narrow passages won't save it - it can squeeze through any crack.
- If there are a group of hatchlings, use explosives or lava traps.
- Don't leave it unattended near the base - it can squeeze through any fence.
