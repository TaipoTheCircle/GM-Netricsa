EVOKER'S FANGS FROM THE MINECRAFT OVERWORLD


CLASS:      Evoker's Fangs
METABOLISM: Magic Projectile
PERCEPTION: Magic projectile from the Evoker's spell
SIZE:       2,6 ft
ENDURANCE:  None
HOSTILITY:  Absolute
WEAPONS:    Bite
...
This is not a weapon, not a tool, and not a living creature in the traditional sense. It is pure magic, materialized in the form of teeth erupting from the ground to devour you alive. They do not exist independently, but are part of the arsenal of the Evoker - one of the most dangerous sorcerers among the Illagers.
...
- As soon as you see purple particles around the Evoker's hands, immediately move out of the line of sight. The fangs move in a straight line.
- Don't stand too close to the Evoker, or you'll be caught in the ring attack. Distance is your greatest ally.
- The fangs don't penetrate walls, but they can reach around corners if there's a clear line of sight.
- The best defense against the fangs is to kill the Evoker before they can summon them.
- Use a shield. The fangs can be blocked, unlike many other magical attacks.
