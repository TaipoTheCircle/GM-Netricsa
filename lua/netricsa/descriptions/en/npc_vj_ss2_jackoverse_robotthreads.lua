SIRIAN ROBOT, PATROL FROM THE SIRIUS


CLASS:      Sirian Robot, Patrol
METABOLISM: Mechanical, Energy
PERCEPTION: Guard Unit, Patrol
SIZE:       ~6,56 ft
ENDURANCE:  High
HOSTILITY:  Extreme
WEAPONS:    Laser Cannon And Camera
REWARD:     1500 FC
THREAT:     High
...
The blue camera on the side of its head isn't just a camera. It's a cannon. It transmits images directly to Mental's army command center. It also fires laser beams. The robot first aims at its target with a small laser pointer, then fires its main cannon.
