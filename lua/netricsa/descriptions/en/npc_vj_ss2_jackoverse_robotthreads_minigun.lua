SIRIAN ROBOT,GUARD FROM THE SIRIUS


CLASS:      Sirian Robot, Guard
METABOLISM: Mechanical, Energy
PERCEPTION: Heavy Assault Unit, Autonomous Combat Platform
SIZE:       9,85 ft
ENDURANCE:  Extreme
HOSTILITY:  Extreme
WEAPONS:    Two 7.62mm M134 Minigun Multi-Barrel Rotary Machine Guns
REWARD:     5000 FC
THREAT:     Absolute

DESCRIPTION:

This is an advanced tracked autonomous combat platform, created by Mental engineers based on the standard Sirian Sentry Robot. Unlike standard guards who patrol the lower levels of Siriuspolis and disperse curious intruders, the Guard is built for war. A true war, where the goal isn't to frighten, but to destroy.
...
This isn't a guard dog. It's a machine for total area cleansing.

TIPS:

- Don't try to attack head-on.
- If he starts shooting, hide behind thick cover.
