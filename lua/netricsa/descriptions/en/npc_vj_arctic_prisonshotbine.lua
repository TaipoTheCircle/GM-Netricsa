COMBINE OVERWATCH ARCTIC PRISON SHOTGUNNER


CLASS:      Combine Overwatch Arctic Prison Shotgunner
METABOLISM: Augmented Human, Male
PERCEPTION: Combine Punishment Assault Unit
SIZE:       5,9 ft
ENDURANCE:  High
HOSTILITY:  Extreme
...
The Overwatch Arctic Prison Soldat with Shotgun is an Combine trooper originally assigned to the Nova Prospekt Facility but temporarily redeployed to Arctic regions. This practice is used when prison zones experience an excess of manpower, while remote sectors suffer a shortage of assault units.
...
- Don't count on his caution-prison soldiers often go head-on.
- The orange visor is noticeable, but he reacts faster than he seems.
- The Nova Prospekt sign means the soldier has nothing to lose.
- In confined spaces, the shotgun makes him deadly.