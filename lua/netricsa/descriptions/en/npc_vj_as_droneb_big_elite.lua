"BETA" SWARM ELITE DRONE, LARGE


CLASS:        "Beta" Swarm Elite Drone, Large
METABOLISM:   Xenobiological
PERCEPTION:   Heavy Pack Predator
SIZE:         9,8 ft
ENDURANCE:    Very High
HOSTILITY:    Extreme
WEAPONS:      Claws, Teeth, Body Mass
REWARD:       1200 FC
THREAT:       Very High
...
Despite its immense mass, the Large Elite Drone retains the aggression and speed characteristic of the "Beta" Swarm. It possesses neither complex intelligence nor special abilities; it has no need for them. Evolution long ago concluded that four massive claws are often more persuasive than any tactic.

TIPS:

- Do not engage in close-quarters combat with it under any circumstances.
- Heavy weaponry is recommended; light weaponry is merely sympathetic.
- Eliminate this type of specimen before it gets close to the squad.
- If a standard drone is a problem, an elite heavy drone is more like a natural disaster with claws.
