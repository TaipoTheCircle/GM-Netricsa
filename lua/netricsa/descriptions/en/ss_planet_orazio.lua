...
PLANET:       Orazio
TYPE:         Terrestrial planet, Mining planet
CLIMATE:      Unstable, harsh
MOONS:        Unknown
TERRAIN:      Deep craters, open-pit mines, industrial zones
LOCATION:     Unknown sector of the galaxy
NATIVE RACES: Orcs, Mental Horde (All Races)
ALLIANCE:     Altani CorpOrazion (formerly), Mental-Altani CorpOrazion (currently)
LOCATIONS:    Orazio Deep Mines, Combat Vehicle Testing Facility
...
- Orazio Deep Mines: A network of tunnels and shafts extending many kilometers beneath the surface. Due to the high radioactivity, work here is carried out exclusively by remotely controlled vehicles.
- Combat vehicle testing Facility: A former quarry converted into a testing center for armed versions of mining robots as part of the "Refurbishment Program".
