...
We're traveling through the countryside to the city. And so on, endlessly. The loop is closed, so you can relax and look out the window.

Features:

The train is full of buttons for turning everything on and off. Do you like pressing buttons? This is the place for you.

There are secrets. They won't say where exactly, but there are definitely some hidden places.

Get into a compartment or a sleeper car, pull the stop lever whenever you want to look around, and don't forget the buttons. If the technology starts glitching, just be thankful we're even traveling. Let's go, Sam!
